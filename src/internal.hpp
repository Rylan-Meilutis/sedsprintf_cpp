...
template <> inline int32_t copy_typed_payload<bool>(const SedsPacketView *pkt, bool *out, size_t out_elems) {
  if (pkt == nullptr) {
    return SEDS_BAD_ARG;
  }
