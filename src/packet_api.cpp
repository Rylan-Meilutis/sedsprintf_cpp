...
std::string hex_dump(const uint8_t* data, size_t len) {
    ...
    for (size_t i = 0; i < len; ++i) {
        ...
        os << "0x" << std::hex << std::setfill('0') << std::setw(2) << static_cast<unsigned>(data[i]) << std::dec;
    }
    return os.str();
}
...
int32_t seds_pkt_serialize_len(const SedsPacketView* view) {
    ...
    return seds::packet_from_view(view, packet) ? static_cast<int32_t>(seds::serialize_packet(packet).size()) : SEDS_BAD_ARG;
}
...
int32_t seds_pkt_get_f32(const SedsPacketView* pkt, float* out, size_t out_elems) { return seds::copy_typed_payload(pkt, out, out_elems); }
int32_t seds_pkt_get_f64(const SedsPacketView* pkt, double* out, size_t out_elems) { return seds::copy_typed_payload(pkt, out, out_elems); }
int32_t seds_pkt_get_u8(const SedsPacketView* pkt, uint8_t* out, size_t out_elems) { return seds::copy_typed_payload(pkt, out, out_elems); }
int32_t seds_pkt_get_u16(const SedsPacketView* pkt, uint16_t* out, size_t out_elems) { return seds::copy_typed_payload(pkt, out, out_elems); }
int32_t seds_pkt_get_u32(const SedsPacketView* pkt, uint32_t* out, size_t out_elems) { return seds::copy_typed_payload(pkt, out, out_elems); }
int32_t seds_pkt_get_u64(const SedsPacketView* pkt, uint64_t* out, size_t out_elems) { return seds::copy_typed_payload(pkt, out, out_elems); }
int32_t seds_pkt_get_i8(const SedsPacketView* pkt, int8_t* out, size_t out_elems) { return seds::copy_typed_payload(pkt, out, out_elems); }
int32_t seds_pkt_get_i16(const SedsPacketView* pkt, int16_t* out, size_t out_elems) { return seds::copy_typed_payload(pkt, out, out_elems); }
int32_t seds_pkt_get_i32(const SedsPacketView* pkt, int32_t* out, size_t out_elems) { return seds::copy_typed_payload(pkt, out, out_elems); }
int32_t seds_pkt_get_i64(const SedsPacketView* pkt, int64_t* out, size_t out_elems) { return seds::copy_typed_payload(pkt, out, out_elems); }
int32_t seds_pkt_get_bool(const SedsPacketView* pkt, bool* out, size_t out_elems) { return seds::copy_typed_payload(pkt, out, out_elems); }
