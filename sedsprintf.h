...
/* ============================================================================
    THIS FILE IS AUTOGENERATED FROM RUST CONFIG - DO NOT EDIT DIRECTLY AS ALL CHANGES WILL BE OVERWRITTEN
   ============================================================================ */
#include <stdint.h>
#include <stddef.h>
...
/* =================================================================
   Public enums / constants *AUTOGENERATED BASED ON RUST CONFIG*
   ================================================================= */
...
/** @brief Override the router sender identifier used for discovery, control, and logged packets. */
...
/** @brief Add a serialized TX side. Returns side id or negative SedsResult. */
...
/** @brief Remove a router side by its previously returned side id. */
 ...
 * Pass -1 for @p src_side_id to target locally-originated router TX traffic.
 */
 ...
 * @param reliable_enabled  Enable reliable ACK/ordering on this side.
 *
